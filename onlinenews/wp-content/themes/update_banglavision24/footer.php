  ...
  <script src="<?php echo esc_url(get_template_directory_uri()); ?>/gslider/js/jssor.slider-21.1.6.mini.js" type="text/javascript"></script>
  <script src="<?php echo esc_url(get_template_directory_uri()); ?>/gslider/js/slider.js" type="text/javascript"></script>
